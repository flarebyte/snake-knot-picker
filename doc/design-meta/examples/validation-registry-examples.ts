...
export const stringEmailRegistration: ValidationRegistry = validationRegistry.register({
  domain: "string",
  name: "email",
...
export const numberIntRegistration: ValidationRegistry = validationRegistry.register({
  domain: "number",
  name: "int",
...
export const formatterTrimRegistration: ValidationRegistry = validationRegistry.register({
  domain: "formatter",
  name: "trim",
...
export const conversionParseIntRegistration: ValidationRegistry = validationRegistry.register({
  domain: "conversion",
  name: "parse-int",
...
export const tuplePairRegistration: ValidationRegistry = validationRegistry.register({
  domain: "tuple",
  name: "pair",
...
export const postalCodeRegistration: ValidationRegistry = validationRegistry.register({
  domain: "string",
  name: "postal-code",
